...
|---|---|---|---|---|
| E1 | Do parents anchor an AI tutoring subscription against the tutoring rate or against software prices? | Owner | A landing page running a tutoring-anchored price point against a software-anchored one, compared on revenue per visitor. Days, small spend, no product. This is condition C1 in docs/09 and milestone M1 in docs/11, and it is adequate to the quantity. | -15,500,849 dollars of terminal cash between the two states. The largest single number here. |
...
| OA-10, the price anchor | Now has a number on it: -15,500,849 dollars between the two states. |

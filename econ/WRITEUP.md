...
0.52 per cent of net revenue and about
6.1 per cent of cost, so the row is
...
**1 of the 20 cash-target solves brackets, and it is the one described
...
14,688,588 as the median of the per-path
differences — the difference of the two marginal medians, which is the column
section 9's table carries, is 14,667,533, and

...
| C3 | What does it cost to author an item, as against validating it? | Content lead | The same pilot, with authoring timed separately. It is a distinct driver and ranks immediately below validation minutes on the capital target, at rank @@sobol_peak_funding_requirement_rank_of_writer_gbp_item|int@@ against rank @@sobol_peak_funding_requirement_rank_of_minutes_per_item|int@@. | Pinned across its range, @@pinned_writer_gbp_item_swing_abs|usd0@@. |
